...
{
    [JsonProperty("magicDamageDone")] public int MagicDamageDone { get; set; }
    ...
    [JsonProperty("physicalDamageDone")] public int PhysicalDamageDone { get; set; }
    ...
    [JsonProperty("totalDamageDone")] public int TotalDamageDone { get; set; }
    ...
    [JsonProperty("trueDamageDone")] public int TrueDamageDone { get; set; }

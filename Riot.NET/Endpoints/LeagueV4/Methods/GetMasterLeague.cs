...
[Path("/masterleagues/by-queue/{0}")]
[RateLimit(TimeUnit.Seconds, 10, 30)]
[RateLimit(TimeUnit.Minutes, 10, 500)]
public class GetMasterLeague(string endpoint, RateLimiter.RateLimiter rateLimiter) : RegionMethodBase<LeagueListDTO>(endpoint, rateLimiter)
{

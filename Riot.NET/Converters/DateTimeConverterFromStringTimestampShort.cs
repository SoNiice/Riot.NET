...
internal class DateTimeConverterFromStringTimestampShort : JsonConverter
{
    ...
    {
        serializer.Serialize(writer, ((DateTime)(value ?? DateTime.MinValue)).ToString("yyyy-MM-dd HH:mm:ss.f"));
    }
}